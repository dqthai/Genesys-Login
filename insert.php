<?php
	...
	$result = pg_query("INSERT INTO users(first,last,alias,email,username,nickname,language,user_license,profile) VALUES('$first', '$last', '$alias', '$email', '$username', '$nickname', '$language', '$user_license', '$profile',)");
